      ...
      */}
      <div>
                  ...
                  <div className="flex grow flex-col gap-y-5 overflow-y-auto bg-pink-600 px-6 pb-2">
                    <div className="flex h-16 shrink-0 items-center">
                      <img
                        ...
                        src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcR3UZ9SyHoaZIi2EU_e4DQzC7kFjMdsyDrciXMW7xbW0GzLyfaTaDD1uGygID3oZ0qMCMk"
                        alt="Your Company"
                      />
                    </div>
        ...
        <div className="hidden lg:fixed lg:inset-y-0 lg:z-50 lg:flex lg:w-16 lg:flex-col">
          {/* Sidebar component, swap this element with another sidebar if you like */}
          <div className="flex grow flex-col gap-y-5 overflow-y-auto bg-pink-600 items-center">
            <div className="flex h-16 shrink-0 items-center">
              <img
                className="h-8 w-auto"
                src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcR3UZ9SyHoaZIi2EU_e4DQzC7kFjMdsyDrciXMW7xbW0GzLyfaTaDD1uGygID3oZ0qMCMk"
